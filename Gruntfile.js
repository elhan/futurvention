...
//          }
    ...
    connect: {
      options: {
        ...
        hostname: 'client.futurvention.com',
        livereload: 35729
      },
      livereload: {
        options: {
      ...
      development: {
        ...
        constants: {
          ENV: {
            name: 'development',
            api: {
              endPoint: 'https://futurvention.azurewebsites.net',
              hostedFiles: 'https://ergmaimages.blob.core.windows.net/userdata/',
      ...
      production: {
        ...
        constants: {
          ENV: {
            name: 'production',
            api: {
              endPoint: 'https://futurventionstage.azurewebsites.net',
              hostedFiles: 'https://ergmaimages.blob.core.windows.net/stageuserdata/',
